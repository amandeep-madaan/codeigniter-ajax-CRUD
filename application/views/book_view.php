...
<html lang="en">
    ...
    <body>
        ...
        <div class="container">
            <h2 class="text-center">Learn PHP CodeIgniter Framework with AJAX and Bootstrap</h2></center>
            <h3>Book Store</h3>
            <br />
            ...
            <table class="table table-striped table-hover" id="table_id">
                ...
                <?php foreach($books as $book1){?>
                    <tr>
                        <td><?php echo $book1->book_id;?></td>
                        <td><?php echo $book1->book_isbn;?></td>
                        <td><?php echo $book1->book_title;?></td>
                        <td><?php echo $book1->book_author;?></td>
                        <td><?php echo $book1->book_category;?></td>
                        <td>
                            <button type="button" class="btn btn-warning" onclick="edit_book(<?php echo $book1->book_id;?>)"><i class="glyphicon glyphicon-pencil"></i></button>
                            <button type="button" class="btn btn-danger" onclick="delete_book(<?php echo $book1->book_id;?>)"><i class="glyphicon glyphicon-remove"></i></button>
                        </td>
                    </tr>
                <?php }?>
                </tbody>
